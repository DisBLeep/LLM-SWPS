...
ONGOING_CONVO_PROMPT    = "Kontynuując poprzednią rozmowę:"
...
def run(user_prompt, first_message_flag, chosen_pdf_filenames):
    ...
    if first_message_flag:
        ...
        next_response   = send_and_receive_message(user_message=user_prompt, 
                                                 ...
                                                 model=MODEL_NLP, 
                                                 chat_inject_agreement=False)
        chats_summary   = next_response
        found_fragments = ""
